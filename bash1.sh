...
export str1 2str = _3str str4=str5    # SEGA !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                      
 'e'"x"p'o'r't'                                                                 
ec"ho" $str1 $str4                    #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                     
...
cd -; pwd                        #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                      
$lkjlkjllkdfs$q$w$e$r "$e"$q"l"'l'$r;    # SEGA !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                          
 echo         \'\"\\           #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                     
echo ~                     #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                         
echo hello sad man                                                              
echo $?                                                                         
...
echo $?                                                                         
unset PWD; echo $PWD           # LEAKS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                  
ls; unset PATH; ls     ;       #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                                                                                                                                                              
export PATH=/  ; ls            #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                                                                                          
export PATH=/bin  ; ls         #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                                                                                      
echo $PWD; unset PWD           # LEAKS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                    
echo $PWD; export PWD=/ ; echo $PWD;   #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                         
pwd; echo $PWD            #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                       
cd; echo $PWD; cd -       #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                          
echo $PWD; echo $OLDPWD    #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                        
unset OLDPWD; echo $OLDPWD    # LEAKS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                       
cd; echo $OLDPWD            #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                       
...
"echo f" hello                                                                  
>"helo l" echo hell\ f                                                         
>>"helo l" echo hell\ f ; echo hell\ f     # LEAKS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                     
...
export PWD=/Users/GBroccol          #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!    NEED FIX
pwd
